...
var cases = []struct {
...
}{
	{
		...
		decodeFunc: func(b []byte) (serializable, error) {
			p := &params.EndOfOptionalParameters{}
		...
		decodeFunc: func(b []byte) (serializable, error) {
			p := &params.LocalReference{}
			if _, err := p.Read(b); err != nil {
				return nil, err
			}
			return p.AsDestination(), nil
		},
	}, {
		...
		serialized:  []byte{0x01},
		decodeFunc: func(b []byte) (serializable, error) {
			p := &params.SegmentingReassembling{}
			if _, err := p.Read(b); err != nil {
				return nil, err
			}
			return p, nil
		...
		decodeFunc: func(b []byte) (serializable, error) {
			p := &params.ReceiveSequenceNumber{}
			if _, err := p.Read(b); err != nil {
				return nil, err
			}
			return p, nil
		...
		structured:  params.NewCredit(0x77).AsOptional(),
		serialized:  []byte{0x09, 0x01, 0x77},
		decodeFunc: func(b []byte) (serializable, error) {
			p := (&params.Credit{}).AsOptional()
			if _, err := p.Read(b); err != nil {
				return nil, err
			}
			return p, nil
		...
		structured:  params.NewData([]byte{0xde, 0xad, 0xbe, 0xef}).AsOptional(),
		serialized:  []byte{0x0f, 0x04, 0xde, 0xad, 0xbe, 0xef},
		decodeFunc: func(b []byte) (serializable, error) {
			p := (&params.Data{}).AsOptional()
			if _, err := p.Read(b); err != nil {
				return nil, err
			}
			return p, nil
		...
		structured:  params.NewHopCounter(0x03).AsOptional(),
		serialized:  []byte{0x11, 0x01, 0x03},
		decodeFunc: func(b []byte) (serializable, error) {
			p := (&params.HopCounter{}).AsOptional()
			if _, err := p.Read(b); err != nil {
				return nil, err
			}
			return p, nil
